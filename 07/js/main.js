...
btn3.addEventListener('click', () => {
  ...
  btn1.addEventListener('click', onClick2)
})
...
function onClick () {
  switch (counter) {
    case 1: console.log(`Clicked ${counter}`)
            break
    case 2: console.log(`Clicked ${counter}`)
            break
    case 3: console.log(`End!`)
            btn1.removeEventListener('click', onClick)
            break
  }
  counter++
...
.addEventListener('click', (e) => {
  document.querySelector('.wrapper').innerHTML += `<button class="btn">Click Me W!</button>`
})
